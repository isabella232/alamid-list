 ...
 * "add"-, "remove"- and "orderChange"-events. Instead of setting and retrieving
...
List.prototype.reverse = function () {
    ...
    emit(this, OrderChangeEvent, "reverse");
...
List.prototype.sort = function () {
    ...
    emit(this, OrderChangeEvent, "sort");
...
List.configure = function (newConfig) {
    config.adapter.emit = newConfig.adapter.emit;
    config.adapter.removeAllListeners = newConfig.adapter.removeAllListeners;
};
...
function emit(self, Event, arg1, arg2, arg3) {
    config.adapter.emit.call(self, Event.prototype.name, new Event(self, arg1, arg2, arg3));
}
